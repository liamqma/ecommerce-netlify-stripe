function SectionAnnouncementBar() {
    return (
        <div className="announcement-bar color-background-2 gradient" role="region" aria-label="Announcement">
            <a href="/collections/leia-bryans" className="announcement-bar__link link link--text focus-inset animate-arrow">
